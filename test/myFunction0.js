var myFunction0 = function(module, exports, __webpack_require__) {
	...
	var escope = __webpack_require__(8);
	var esprima = __webpack_require__(88);
	...
	var run = function () {
	    ...
	    var traverseNode = function (node, key, level) {
	        ...
	        var name, result, value, innerValue, icon, locLink;
	    ...
	    $('input[name="es"]').change(function () {
	        ecmaVersion = $(this).val();draw();
	    });
	    $('input[name="st"]').change(function () {
	        sourceType = $(this).val();draw();
	    });
